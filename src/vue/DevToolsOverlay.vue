...
<style scoped>
.wf-devtools-marks{position:fixed;inset:0;z-index:calc(var(--wf-layer-overlay) + 20);pointer-events:none}.wf-devtools-mark{position:fixed;box-sizing:border-box;border:1px dashed var(--wf-color-focus);box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--wf-color-focus) 24%,transparent)}.wf-devtools-mark--window{border-width:2px;border-style:solid}.wf-devtools-mark--drop-zone{border-color:var(--wf-color-accent);border-width:2px}.wf-devtools-mark span{position:absolute;top:0;left:0;max-width:100%;padding:2px 4px;background:var(--wf-color-surface-floating);color:var(--wf-color-text);font:10px/1.2 var(--wf-font-family);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.wf-devtools{position:fixed;right:12px;bottom:12px;z-index:calc(var(--wf-layer-overlay) + 30);width:min(440px,calc(100vw - 24px));max-height:min(72vh,720px);display:flex;flex-direction:column;border:1px solid var(--wf-color-border-overlay);border-radius:var(--wf-radius-md);background:var(--wf-color-surface-overlay);box-shadow:var(--wf-shadow-lg);color:var(--wf-color-text);font:var(--wf-font-size-xs)/1.35 var(--wf-font-family)}.wf-devtools>header{display:flex;align-items:center;gap:var(--wf-space-sm);padding:var(--wf-space-sm) var(--wf-space-md);border-bottom:1px solid var(--wf-color-border-overlay)}.wf-devtools>header strong{flex:1}.wf-devtools button,.wf-devtools kbd{border:1px solid var(--wf-color-border-floating);border-radius:var(--wf-radius-sm);background:var(--wf-color-surface-floating);color:inherit;font:inherit}.wf-devtools button{cursor:pointer}.wf-devtools__summary{display:flex;flex-wrap:wrap;gap:var(--wf-space-sm);padding:var(--wf-space-xs) var(--wf-space-md);color:var(--wf-color-text-muted)}.wf-devtools__content{overflow:auto;padding:0 var(--wf-space-md) var(--wf-space-md)}.wf-devtools details{border-top:1px solid var(--wf-color-border-overlay);padding:var(--wf-space-xs) 0}.wf-devtools summary{cursor:pointer;font-weight:var(--wf-font-weight-semibold)}.wf-devtools ul{display:grid;gap:3px;margin:var(--wf-space-xs) 0;padding:0;list-style:none}.wf-devtools li{display:grid;grid-template-columns:minmax(100px,1fr) auto;gap:2px var(--wf-space-sm);min-width:0}.wf-devtools li code{overflow:hidden;text-overflow:ellipsis}.wf-devtools li small{grid-column:1/-1;color:var(--wf-color-text-muted)}.wf-devtools pre{max-height:260px;overflow:auto;margin:var(--wf-space-xs) 0 0;padding:var(--wf-space-sm);background:var(--wf-color-canvas);font:10px/1.35 ui-monospace,SFMono-Regular,Consolas,monospace;white-space:pre-wrap;word-break:break-word}
</style>
