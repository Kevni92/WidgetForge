...
function requestClose(): void { layoutPickerOpen.value = false; dockPickerOpen.value = false; emit('close', { instanceId: props.instanceId }) }
function toggleMinimized(): void { layoutPickerOpen.value = false; dockPickerOpen.value = false; const event = { instanceId: props.instanceId }; if (props.minimized) emit('restore', event); else emit('minimize', event) }
