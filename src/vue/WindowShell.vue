...
<style scoped>
.wf-window-shell{display:flex;min-width:0;min-height:0;flex-direction:column;overflow:visible;color:var(--wf-color-text);background:var(--wf-color-surface);border:1px solid var(--wf-color-border);border-radius:var(--wf-radius-md);box-shadow:var(--wf-shadow-md);font-family:var(--wf-font-family)}.wf-window-shell--focused{border-color:var(--wf-color-focus)}.wf-window-shell--maximized{border-radius:0}.wf-window-shell--role-utility{box-shadow:var(--wf-shadow-sm)}.wf-window-shell--role-overlay{background:var(--wf-color-surface-raised);box-shadow:var(--wf-shadow-sm)}.wf-window-shell--role-modal{box-shadow:var(--wf-shadow-lg)}.wf-window-shell--chrome-borderless{border-color:transparent}.wf-window-shell--chrome-none{border-color:transparent;border-radius:0;box-shadow:none}.wf-window-shell--glass{background:color-mix(in srgb,var(--wf-color-surface) 78%,transparent);backdrop-filter:blur(10px)}.wf-window-shell__titlebar{display:flex;min-height:var(--wf-size-titlebar-height);align-items:center;justify-content:space-between;gap:var(--wf-space-sm);padding:0 var(--wf-space-sm) 0 var(--wf-space-md);background:var(--wf-color-surface-raised);border-bottom:1px solid var(--wf-color-border);user-select:none}.wf-window-shell--glass .wf-window-shell__titlebar{background:color-mix(in srgb,var(--wf-color-surface-raised) 78%,transparent)}.wf-window-shell--chrome-borderless .wf-window-shell__titlebar,.wf-window-shell--chrome-none .wf-window-shell__titlebar{border-bottom-color:transparent}.wf-window-shell--minimized .wf-window-shell__titlebar{border-bottom:0}.wf-window-shell__leading,.wf-window-shell__actions{display:flex;min-width:0;align-items:center;gap:var(--wf-space-xs)}.wf-window-shell__leading{flex:1}.wf-window-shell__title{min-width:0;overflow:hidden;font-size:var(--wf-font-size-sm);font-weight:var(--wf-font-weight-medium);text-overflow:ellipsis;white-space:nowrap}.wf-window-shell__icon{flex:0 0 auto;color:var(--wf-color-accent)}.wf-window-shell__badge{flex:0 0 auto;padding:1px var(--wf-space-xs);border:1px solid var(--wf-color-border);border-radius:var(--wf-radius-sm);color:var(--wf-color-accent);font-size:var(--wf-font-size-xs)}.wf-window-shell__status{color:var(--wf-color-text-muted);font-size:var(--wf-font-size-xs);white-space:nowrap}.wf-window-shell__actions{position:relative}.wf-window-shell__layout-action{position:relative}.wf-window-shell__header-action,.wf-window-shell__minimize,.wf-window-shell__maximize,.wf-window-shell__close{min-width:var(--wf-size-control-height);height:var(--wf-size-control-height);padding:0 var(--wf-space-xs);color:var(--wf-color-text-muted);background:transparent;border:0;border-radius:var(--wf-radius-sm);font:inherit;cursor:pointer}.wf-window-shell__header-action:hover:not(:disabled),.wf-window-shell__minimize:hover,.wf-window-shell__maximize:hover,.wf-window-shell__close:hover{color:var(--wf-color-text);background:var(--wf-color-hover)}.wf-window-shell__header-action:focus-visible,.wf-window-shell__minimize:focus-visible,.wf-window-shell__maximize:focus-visible,.wf-window-shell__close:focus-visible{outline:2px solid var(--wf-color-focus);outline-offset:-2px}.wf-window-shell__header-action:disabled{cursor:default;opacity:.5}.wf-window-shell__content{min-width:0;min-height:0;flex:1;padding:var(--wf-space-md);overflow:hidden}.wf-window-shell__content :deep(.wf-pane-host){width:100%;height:100%}
</style>
