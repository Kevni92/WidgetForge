...
<style scoped>
.wf-window-snap-layout-picker{position:absolute;top:calc(100% + var(--wf-space-xs));right:0;z-index:var(--wf-layer-overlay);display:grid;grid-template-columns:repeat(4,minmax(76px,1fr));gap:var(--wf-space-xs);width:min(420px,80vw);padding:var(--wf-space-sm);border:1px solid var(--wf-color-border-floating);border-radius:var(--wf-radius-md);background:var(--wf-color-surface-floating);box-shadow:var(--wf-shadow-lg)}
