...
const root=ref<HTMLElement|null>(null);const size=shallowRef<WindowSize>({width:0,height:0});const dockStates=shallowRef<readonly DockState[]>(dockManager.list())
