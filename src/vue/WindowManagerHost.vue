...
function windowDockable(window:WindowState):boolean{return !props.layoutLocked&&!window.layoutLocked&&window.mode==='normal'&&(window.options.role==='normal'||window.options.role==='utility')&&!isCommandLauncherPane(window.rootPane)}
