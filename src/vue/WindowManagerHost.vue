...
interface WindowManagerHostProps { manager:WindowManager;registry:WidgetRegistry;layoutLocked?:boolean;editMode?:boolean;paneDragEnabled?:(windowId:string,paneId:string)=>boolean;groups?:WindowGroupManager }
