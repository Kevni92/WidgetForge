...
export { cloneWindowLayoutSpec, createAbsoluteWindowLayoutSpec, createWindowLayoutSpecFromSnap, deriveWindowLayoutStatus, findWindowLayoutDependents, layoutSpecReferencesWindow, resolveWindowLayoutSpecs, validateWindowLayoutReferences, validateWindowLayoutSpec, WindowLayoutValidationError } from './core/window-layout'
export type { ResponsiveLayoutWindow, WindowLayoutAnchor, WindowLayoutAxisSpec, WindowLayoutEdge, WindowLayoutLength, WindowLayoutRuleState, WindowLayoutSize, WindowLayoutSpec, WindowLayoutStatus, WindowLayoutStatusInput, WindowLayoutSurfaceState, WindowLayoutTarget, WindowLayoutUnit, WindowLayoutValidationErrorCode, WindowLayoutWindowTarget, WindowLayoutWorkspaceTarget } from './core/window-layout'
