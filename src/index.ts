...
export { cloneWindowLayoutSpec, createAbsoluteWindowLayoutSpec, createWindowLayoutSpecFromSnap, layoutSpecReferencesWindow, resolveWindowLayoutSpecs, validateWindowLayoutReferences, validateWindowLayoutSpec, WindowLayoutValidationError } from './core/window-layout'
export type { ResponsiveLayoutWindow, WindowLayoutAnchor, WindowLayoutAxisSpec, WindowLayoutEdge, WindowLayoutLength, WindowLayoutSize, WindowLayoutSpec, WindowLayoutTarget, WindowLayoutUnit, WindowLayoutValidationErrorCode, WindowLayoutWindowTarget, WindowLayoutWorkspaceTarget } from './core/window-layout'
