...
export { createWidgetPane, createSplitPane, createTabPane, clonePaneTree, validatePaneTree, findPane, containsPane, replacePane, removePane, splitPaneAt, tabPaneAt, movePane, movePaneToTabs, setSplitWeights, setActiveTab, reorderTab, PaneDefinitionError, UnknownPaneError, InvalidPaneOperationError } from './core/pane'
export type { PaneId, PaneAxis, PaneOverflow, PaneBackground, PaneParameterValue, PaneParameters, PaneSplitEdge, PaneSettings, WidgetPane, SplitPane, TabPane, PaneNode, CreateWidgetPaneOptions, CreateSplitPaneOptions, CreateTabPaneOptions, RemovePaneResult } from './core/pane'
...
export type { WindowHeaderMode, WindowLayer, WindowRole, WindowOptions, WindowOptionsOverride } from './core/window-options'
