...
describe('ThemeProvider', () => {
  ...
  it('exposes role and backdrop tokens to custom themes without component overrides', () => {
    ...
    expect(style).toContain(`--wf-size-icon-size: ${defaultTheme.size.iconSize}`)
    expect(style).toContain(`--wf-size-icon-button-size: ${defaultTheme.size.iconButtonSize}`)
    expect(style).toContain(`--wf-size-tab-height: ${defaultTheme.size.tabHeight}`)
