...
<template>
  ...
  <div class="workspace-dock-showcase__hint">Normal: drag a tab grip to reorder tabs. Edit mode/Ctrl: drag any pane surface or tab button to rearrange the workspace, or drop it on free space to open a new window.</div>
