...
export const productionWidget=defineWidget({id:'economy.production',title:'Production',component:ProductionWidget,capabilities:{multipleInstances:true,dockable:true,tabCompatible:true,minimumUsefulSize:{width:330,height:220},supportsCompactMode:true},viewState:linkedViewState,window:{defaultSize:{width:440,height:300},minSize:{width:330,height:220}}})
export const inventoryWidget=defineWidget({id:'economy.inventory',title:'Inventory',component:InventoryWidget,capabilities:{multipleInstances:true,dockable:true,tabCompatible:true,minimumUsefulSize:{width:390,height:240},supportsCompactMode:false},viewState:{version:1,defaultState:{filter:'',sortColumn:'quantity',sortDirection:'desc',selection:{followSelection:true,pinnedSelection:null}},validate:(value):value is {filter:string;sortColumn:string;sortDirection:'asc'|'desc';selection:DemoLinkedSelection}=>{if(typeof value!=='object'||value===null)return false;const state=value as {filter?:unknown;sortColumn?:unknown;sortDirection?:unknown;selection?:unknown};return typeof state.filter==='string'&&typeof state.sortColumn==='string'&&(state.sortDirection==='asc'||state.sortDirection==='desc')&&isLinkedSelection(state.selection)}},window:{defaultSize:{width:500,height:320},minSize:{width:390,height:240}}})
export const ordersWidget=defineWidget({id:'economy.orders',title:'Orders',component:OrdersWidget,capabilities:{multipleInstances:true,dockable:true,tabCompatible:true,minimumUsefulSize:{width:390,height:230},supportsCompactMode:false},viewState:linkedViewState,window:{defaultSize:{width:500,height:300},minSize:{width:390,height:230}}})
