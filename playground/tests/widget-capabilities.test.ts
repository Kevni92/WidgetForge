...
describe('playground widget capabilities', () => {
  it('demonstrates distinct floating, docked and compact-capable profiles', () => {
    expect(playgroundWidgetRegistry.getCapabilities('market.ticker')).toMatchObject({ multipleInstances: false, dockable: false, tabCompatible: true, supportsCompactMode: false })
